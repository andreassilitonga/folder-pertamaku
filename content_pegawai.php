				...
				<div class="aside aside-left d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<?php include "proses/pegawai_menu.php";?>
						</div>
						<!--end::Menu Container-->
					</div>
					<!--end::Aside Menu-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-md">
										...
										<ul class="navi navi-hover py-5">
											<li class="navi-item">
												<a href="account_pegawai.bpom" class="navi-link">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								if ($_GET[view] == 'home' or $_GET[view] == '') {
									include "proses/pegawai_dashboard.php";
								} elseif ($_GET[view] == 'account_pegawai') {
									include "proses/pegawai_password.php";
								} elseif ($_GET[view] == 'karyawan') {
									include "proses/pegawai_edit.php";
								} elseif ($_GET[view] == 'karyawanc') {
									if ($_GET[act] == '') {
										include "proses/pegawai_edit.php";
									} elseif ($_GET[act] == 'edit_pegawai') {
										include "proses/admin_detail.php";
									} elseif ($_GET[act] == 'input') {
										include "proses/admin_input.php";
									} elseif ($_GET[act] == 'excel') {
										include "proses/c_pain_excel.php";
									}
								}
								?>
								<!--end::Dashboard-->
